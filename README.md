...
Unlike many other libraries, FlatFiles also allows fine-grain control over the way it interprets the schema of your files. It gives you complete control over the way dates, numbers and enums are interpreted in your files. This means less struggling with the types of formatting issues that plague most other libraries.
